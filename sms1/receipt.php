          ...
          <section class="wrapper">
              <section id="page-title">
						<div class="row">
									...
									<h1>&nbsp&nbsp&nbspAdd Patient</h1>
				          			...
				          			<div class="col-lg-8">
							          	...
							          	<div class="panel panel-default">
							          	    <div class="panel-body">
									            ...
									            <div align="center">
									            	<button class="btn btn-primary" onclick="return confirmInvoice('')">Print and Save </button>
						                        	<button class="btn btn-primary" onclick="return confirm('')">Add Patient</button>
