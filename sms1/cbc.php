      ...
      <section id="main-content">
        ...
        <div class="row">
			...
			if(isset($_GET['idNo']) && $_GET['idNo'] <> ''){
                ...
                <form action="add_cbc_result.php" method="post">
                        ...
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
		                            ...
		                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="haemoglobin" value="Nil" style="border:1px solid" onFocus="this.select()" /></td>
		                        ...
		                        <tr>
		                            ...
		                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
		                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="esr" value="Nil" style="border:1px solid" onFocus="this.select()" /></td>
		                            <td colspan="2" width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
		                        </tr>
                        ...
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="platelets" name="platelets" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="rbc" name="rbc" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="reticulocyte" name="reticulocyte" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="cirEosinophil" name="cirEosinophil" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="neurophils" name="neurophils" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="lymphocytes" name="lymphocytes" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                            	<table border="0" width="100%">
                                <tr>
                                	<td width="40%"><label class="control-label" for="monocytes">Monocytes</label></td>
                                    <td><input autoComplete="off" type="text" value="Nil" id="monocytes" name="monocytes" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="eosinophils" name="eosinophils" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="basophils" name="basophils" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="atypicalCells" name="atypicalCells" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="blastCells" name="blastCells" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="proMylocyte" name="proMylocyte" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="myetocyte" name="myetocyte" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="metaMylocyte" name="metaMylocyte" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row" id="box">
                        	<div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td><input autoComplete="off" type="text" value="Nil" id="bandForm" name="bandForm" class="input-control" onFocus="this.select()"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
