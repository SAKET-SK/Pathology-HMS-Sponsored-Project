...
<?php
	...
	//if($addResult){
		$getResult = $mysqli->query("select * from urine join invoice on urine.idNo = invoice.idNo where urine.idNo = '$_GET[idNo]'");
        	...
        	<td width="50%" valign="top">
                ...
                <tr>
                    <td>
                        ...
                        <tr>
                            <td width="40%"><label class="" for="colour">Colour</label></td>
