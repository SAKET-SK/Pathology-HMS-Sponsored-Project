      ...
      <section id="main-content">
          ...
          <div class="row">
			...
			if(isset($_GET['idNo']) && $_GET['idNo'] <> ''){
				...
				$query = $mysqli->query("select * from stool join invoice on stool.idNo = invoice.idNo where stool.idNo = '$_GET[idNo]'");
                ...
                <form action="edit_stool_result.php" method="post">
                ...
                <div class="row">
                	<div class="col-lg-12">
                        ...
                        <tr>
                            ...
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="consistency" value="<?php echo $array['consistency']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                        ...
                        <tr>
                            ...
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="colour" value="<?php echo $array['colour']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td colspan="2" width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
                        </tr>
                        <tr>
                        	<td width="24%" style="border-bottom:1px solid; padding:5px">Mucus</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td colspan="2" width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="mucus" value="<?php echo $array['mucus']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                        ...
                        <tr>
                            ...
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="protozoa" value="<?php echo $array['protozoa']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="24%" style="border-bottom:1px solid; padding:5px">Cysts</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="cysts" value="<?php echo $array['cysts']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">
                            	<table border="0" width="60%">
                                <tr>
                                	<td width="49%" style="padding:0px 5px">Reducing Substance</td>
                                    <td width="1%" style="">:</td>
                                    <td width="50%" style="padding:0px 5px"><input type="text" name="reducing_substance" value="<?php echo $array['reducing_substance']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                                </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="ova" value="<?php echo $array['ova']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">
                            <table border="0" width="60%">
                            <tr>
                                <td width="49%" style="padding:0px 5px">Occult Blood Test</td>
                                <td width="1%" style="">:</td>
                                <td width="50%" style="padding:0px 5px"><input type="text" name="occult_blood_test" value="<?php echo $array['occult_blood_test']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            </tr>
                            </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="larva" value="<?php echo $array['larva']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">
                            <table border="0" width="60%">
                            <tr>
                                <td width="49%" style="padding:0px 5px">Total Ova Count</td>
                                <td width="1%" style="">:</td>
                                <td width="50%" style="padding:0px 5px"><input type="text" name="total_ova_count" value="<?php echo $array['total_ova_count']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            </tr>
                            </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="pus_cell" value="<?php echo $array['pus_cell']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="24%" style="border-bottom:1px solid; padding:5px">RBC</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="rbc" value="<?php echo $array['rbc']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="24%" style="border-bottom:1px solid; padding:5px">Macrophage</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="macrophage" value="<?php echo $array['macrophage']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="24%" style="border-bottom:1px solid; padding:5px">Fat Globules</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="fat_globules" value="<?php echo $array['fat_globules']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="24%" style="border-bottom:1px solid; padding:5px">Vegetable Cells</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="vegetable_cells" value="<?php echo $array['vegetable_cells']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="24%" style="border-bottom:1px solid; padding:5px">Candida</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="25%" style="border-bottom:1px solid; padding:5px"><input type="text" name="candida" value="<?php echo $array['candida']; ?>" style="border:1px solid" onFocus="this.select()" /></td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
                        </tr>
                        </table>
                    </div>
