...
?>
<style>
    .col-lg-12 h5{text-align:right;}
    .col-lg-12 h5 span{
        width: 30%;
        color:#ea6d12;font-size:24px;
            ...
            <div class="row">
               <div class="col-lg-12">
                <?php
					...
					?>
					<h5>Total Income <span ><?php echo $total_income;?></span><sup>৳</sup> </h5>
					<h5>Due Collection<span ><?php echo $dueCollection;?></span><sup>৳</sup> </h5>
					<h5>Total Expense <span ><?php echo $total_expense; ?></span><sup>৳</sup> </h5>
					<h5>Total Due <span ><?php echo $total_due; ?></span><sup>৳</sup> </h5>
					<h5>Refd Amount <span ><?php echo $refd_amount; ?></span><sup>৳</sup> </h5>
					<h5>C/O Amount <span ><?php echo $co_amount; ?></span><sup>৳</sup> </h5>
					<p style="border-bottom:1px solid #777;display:block;"></p>
					<h5>Balance <span ><?php echo $balance; ?></span><sup>৳</sup> </h5>
