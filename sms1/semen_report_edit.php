      ...
      <section id="main-content">
          ...
          <div class="row">
			...
			if(isset($_GET['idNo']) && $_GET['idNo'] <> ''){
				...
				$query = $mysqli->query("select * from semen join invoice on semen.idNo = invoice.idNo where semen.idNo = '$_GET[idNo]'");
                ...
                <form action="edit_semen_result.php" method="post">
                ...
                <div class="row">
                	<div class="col-lg-12">
                        ...
                        <tr>
                            ...
                            <td width="50%" style="border-bottom:1px solid; padding:5px">About <input type="text" style="border:1px solid" name="volume" value="<?php echo $array['volume']; ?>" onFocus="this.select()"> ml</td>
                        </tr>
                        <tr>
                        	<td width="49%" style="border-bottom:1px solid; padding:5px; font-weight:bold">2. Colour</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px"><input type="text" style="border:1px solid" name="colour" value="<?php echo $array['colour']; ?>" onFocus="this.select()"></td>
                        </tr>
                        <tr>
                        	<td width="49%" style="padding:5px; font-weight:bold">3. Liquefacation</td>
                            <td width="1%" style="padding:5px">:</td>
                            <td width="50%" style="padding:5px"><input type="text" style="border:1px solid" name="liquefacation" value="<?php echo $array['liquefacation']; ?>" onFocus="this.select()"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px"><input type="text" style="border:1px solid" name="ph" value="<?php echo $array['ph']; ?>" onFocus="this.select()"></td>
                        </tr>
                        <tr>
                        	<td width="49%" style="padding:5px; font-weight:bold">5. Sperm Count</td>
                            <td width="1%" style="padding:5px">:</td>
                            <td width="50%" style="padding:5px"><input type="text" style="border:1px solid" name="sperm_count" value="<?php echo $array['sperm_count']; ?>" onFocus="this.select()"> Millions/ml</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="padding:0px 5px; padding-top:3px">
                                ...
                                <td> : <input type="text" style="border:1px solid" name="actively_motility" value="<?php echo $array['actively_motility']; ?>" onFocus="this.select()"> %
                                </td>
                               	</tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="padding:0px 5px; padding-top:3px">
                                ...
                                <td> : <input type="text" style="border:1px solid" name="feebly_motility" value="<?php echo $array['feebly_motility']; ?>" onFocus="this.select()"> %
                                </td>
                               	</tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="padding:0px 5px; border-bottom:1px solid; padding-top:3px">
                                ...
                                <td> : <input type="text" style="border:1px solid" name="non_motility" value="<?php echo $array['non_motility']; ?>" onFocus="this.select()"> %
                                </td>
                               	</tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="padding:0px 5px; padding-top:3px">
                                ...
                                <td> : <input type="text" style="border:1px solid" name="s_m_normal" value="<?php echo $array['s_m_normal']; ?>" onFocus="this.select()"> %
                                </td>
                               	</tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="padding:0px 5px; padding-top:3px">
                                ...
                                <td> : <input type="text" style="border:1px solid" name="s_m_abnormal" value="<?php echo $array['s_m_abnormal']; ?>" onFocus="this.select()"> %
                                </td>
                               	</tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="padding:0px 5px; padding-top:3px">
                                ...
                                <td> : <input type="text" style="border:1px solid" name="pus_cells" value="<?php echo $array['pus_cells']; ?>" onFocus="this.select()"> /HPF
                                </td>
                               	</tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="padding:0px 5px; padding-top:3px">
                                ...
                                <td> : <input type="text" style="border:1px solid" name="epithelial_cells" value="<?php echo $array['epithelial_cells']; ?>" onFocus="this.select()"> /HPF
                                </td>
                               	</tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="padding:0px 5px; border-bottom:1px solid; padding-top:3px">
                                ...
                                <td> : <input type="text" style="border:1px solid" name="rbc" value="<?php echo $array['rbc']; ?>" onFocus="this.select()"> /HPF
                                </td>
                               	</tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px"><input type="text" style="border:1px solid" name="sperm_viability" onFocus="this.select()" value="<?php echo $array['sperm_viability']; ?>"></td>
                        </tr>
                        <tr>
                        	<td width="49%" style="border-bottom:1px solid; padding:5px; font-weight:bold">10. Sperm Clumping</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px"><input type="text" style="border:1px solid" name="sperm_clumping" onFocus="this.select()" value="<?php echo $array['sperm_clumping']; ?>"></td>
                        </tr>
                        <tr>
                        	<td width="49%" style="border-bottom:1px solid; padding:5px; font-weight:bold">11. Fructose Test</td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">:</td>
                            <td width="50%" style="border-bottom:1px solid; padding:5px"><input type="text" style="border:1px solid" name="fructose_test" onFocus="this.select()" value="<?php echo $array['fructose_test']; ?>"></td>
                        </tr>
                        <tr>
                        	<td width="49%" style="border-bottom:1px solid; padding:5px; font-weight:bold">
                                ...
                                <tr>
                                    ...
                                    <td width="1%">:</td>
                                    <td width="50%" style="padding:5px"><input type="text" style="border:1px solid" name="opinion" onFocus="this.select()" value="<?php echo $array['opinion']; ?>"></td>
                                </tr>
                                <tr valign="top">
                                	<td width="49%">Advice</td>
                                    <td width="1%">:</td>
                                    <td width="50%" style="padding:5px"><textarea name="advice" style="border:1px solid"><?php echo $array['advice']; ?></textarea></td>
                                </tr>
                                </table>
                            </td>
                            <td width="1%" style="border-bottom:1px solid; padding:5px">&nbsp;</td>
