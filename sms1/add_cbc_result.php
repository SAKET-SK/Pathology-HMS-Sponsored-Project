...
<?php
    ...
    $mysqli->query("insert into cbc values('', '$_POST[idNo]', '$_POST[haemoglobin]',$colormetric, '$_POST[esr]', '$_POST[wbc]', '$_POST[platelets]', '$_POST[rbc]', '$_POST[reticulocyte]', '$_POST[cirEosinophil]', '$_POST[neurophils]', '$_POST[lymphocytes]','$_POST[monocytes]', '$_POST[eosinophils]', '$_POST[basophils]', '$_POST[atypicalCells]', '$_POST[blastCells]',  '$_POST[proMylocyte]', '$_POST[myetocyte]', '$_POST[metaMylocyte]', '$_POST[bandForm]',  '$date', '$time')") or die($mysqli->error);
